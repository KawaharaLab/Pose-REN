...
def make_pose_ren_net(output_dir, dataset):
    with open('{}/deploy_{}_pose_ren.prototxt'.format(output_dir, dataset), 'w') as f:
        f.write(deploy_pose_ren_net(dataset))

if __name__ == '__main__':
    make_pose_ren_net('../../models', 'nyu')
